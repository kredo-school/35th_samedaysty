<x-app-layout>
    ...
    <div class="px-20">
        ...
        <div class="pt-3 flex items-center">
            <a href="{{ route('profile.show', $plan->user->id)}}">{!! $plan->user->avatar ? '<img
                    src="' . $plan->user->avatar . '" alt="avatar" class="w-10 h-10 rounded-full">' : '<i
            ...
            <div class="flex justify-end space-x-5 py-2 items-center">
                ...
                >
                    ...
                    <div x-show="openLike" x-transition x-cloak 
                        class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50" style="display: none;">
