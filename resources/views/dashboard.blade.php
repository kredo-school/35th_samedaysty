            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm">
                <div class="h-screen bg-cover bg-center shadow-lg"
                    ...
                    <div class="grid grid-cols-2 grid-rows-2 h-full w-full gap-10 p-10">
                        ...
                        <!--profile-->
                        <a
                            class="w-full h-full relative bg-white/5  text-white font-bold rounded-lg flex items-center justify-center text-4xl hover:bg-white/40 border border-transparent hover:border-orange-500 transition">
